"""
Django settings for student_ids project.
...
SECRET_KEY = 'twxj91mf=ivklc=bs0=edrj#_@t0%$5znc5z2gqqyxi_7rwo(e'
...
WSGI_APPLICATION = 'student_ids.wsgi.application'
